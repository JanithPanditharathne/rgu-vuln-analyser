...
new_file_cwe78='CWE78_OS_Command_Injection1.txt'
            
 
def removeCurlyBraces():
    
    with open(sourcefilepath+file_cwe78, 'r') as my_file:
        text = my_file.read()
        text = text.replace("{", "")
        text = text.replace("}", "")
...
# save the updates back into a cleaned up file
    with open(sourcefilepath+file_cwe78, 'w') as my_file:
        my_file.write(text)
...
def removeSpecLines():
    ...
    with open(sourcefilepath+file_cwe78) as oldfile, open(sourcefilepath+ new_file_cwe78, 'w') as newfile:
        for line in oldfile:
            if not any(bad_word in line for bad_word in bad_words):
                newfile.write(line)
    
    os.remove(sourcefilepath+file_cwe78)              
    os.rename(sourcefilepath+new_file_cwe78, sourcefilepath+file_cwe78 )
  
def removeSpecWord():
    
    delete_list = ["goodG2B"]
    with open(sourcefilepath+file_cwe78) as fin, open(sourcefilepath+ new_file_cwe78, "w+") as fout:
        for line in fin:
...
def removewordsdoublequotes():
    ...
    with open(sourcefilepath+file_cwe78) as infile, open(sourcefilepath+ new_file_cwe78, 'w') as outfile:
        for line in infile:
...
def replaceVar():
    ...
    with open(sourcefilepath+file_cwe78) as f:
    ...
    with open(sourcefilepath+ new_file_cwe78,"w") as f1:
        f1.write(lines)
...
def fileInput():
    ...
    with open(sourcefilepath+file_cwe78, 'r+') as f:
        _text = ''
        for line in f:
