...
vuln_dataset = pd.read_csv('C:\\Users\\User\\Desktop\\Java\\codes\\Cleaned\\dataset.csv', index_col=0)
...
for i in range(0, len(vuln_dataset)):
    review = re.sub('[^a-zA-Z]', ' ', str(vuln_dataset['code'][i])) # remove unnessary characters
